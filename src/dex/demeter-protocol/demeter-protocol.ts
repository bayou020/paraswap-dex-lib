...
import { DemeterProtocolData } from './types';
...
export class DemeterProtocol
  ...
  implements IDex<DemeterProtocolData>
{
  ...
  constructor(
    ...
    this.eventPools = new DemeterProtocolEventPool(
      dexKey,
      network,
      dexHelper,
      this.logger,
  ...
  async getPricesVolume(
    ...
    blockNumber: number,
    limitPools?: string[],
  ): Promise<null | ExchangePrices<DemeterProtocolData>> {
    // TODO: complete me!
    return null;
  }
  ...
  getCalldataGasCost(
    poolPrices: PoolPrices<DemeterProtocolData>,
  ): number | number[] {
